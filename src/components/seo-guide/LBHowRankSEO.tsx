const features = [
  { label: "Internal link suggestions", from: "0 internal links", to: "5 contextual links added", score: "+8" },
  { label: "Topic clustering", from: "Isolated pages", to: "3 topic clusters mapped", score: "+12" },
  { label: "Content quality score", from: "Thin page, 320 words", to: "Comprehensive guide, 1,800 words", score: "+15" },
  { label: "Anchor text analysis", from: "Generic: click here", to: "Descriptive: link building guide", score: "+5" },
  { label: "Link-worthy content gaps", from: "Missing 4 subtopics", to: "All key subtopics covered", score: "+10" },
];

export function LBHowRankSEO() {
  return (
      ...
      <div className="mx-auto max-w-[1000px] px-6">
        <div className="text-center">
          ...
          <p className="reveal reveal-delay-2 mt-4 mx-auto max-w-[560px] text-[16px] leading-[1.7] text-muted">
            RankSEO won&apos;t build backlinks for you &mdash; no tool honestly
            can. But it helps you create content worth linking to, improve
            internal linking, and organize your site into strong topic clusters.
          </p>
        </div>
        ...
        <div className="reveal reveal-delay-2 mt-12 overflow-hidden rounded-2xl border border-black/[0.06] bg-white shadow-[0_4px_24px_-8px_rgba(0,0,0,0.08)]">
          <div className="flex items-center justify-between border-b border-border-light bg-border-light/20 px-6 py-3.5">
            <span className="text-[13px] font-medium text-foreground">Link SEO Improvements</span>
            <div className="flex items-center gap-2">
              <span className="text-[12px] text-muted">Score:</span>
              <span className="rounded-full bg-success-bg px-2.5 py-0.5 text-[12px] font-bold text-success">82/100</span>
            </div>
          </div>
