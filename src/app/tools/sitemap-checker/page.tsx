...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Sitemap Checker | RankSEO", description: "Free tool to check XML sitemap structure for SEO.", url: "https://www.rankseoengine.com/tools/sitemap-checker", siteName: "RankSEO", type: "website" },
  ...
  alternates: { canonical: "https://www.rankseoengine.com/tools/sitemap-checker" },
};
