...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Open Graph Checker | RankSEO", description: "Free tool to check Open Graph tags for social sharing.", url: "https://www.rankseoengine.com/tools/open-graph-checker", siteName: "RankSEO", type: "website" },
  ...
  alternates: { canonical: "https://www.rankseoengine.com/tools/open-graph-checker" },
};
