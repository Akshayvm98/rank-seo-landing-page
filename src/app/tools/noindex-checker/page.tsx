...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Noindex Checker | RankSEO", description: "Free tool to check noindex and robots directives.", url: "https://rankseoengine.com/tools/noindex-checker", siteName: "RankSEO", type: "website" },
  ...
  alternates: { canonical: "https://rankseoengine.com/tools/noindex-checker" },
};
