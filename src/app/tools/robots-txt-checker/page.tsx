...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Robots.txt Checker | RankSEO", description: "Free tool to analyze robots.txt for SEO.", url: "https://www.rankseoengine.com/tools/robots-txt-checker", siteName: "RankSEO", type: "website" },
  twitter: { card: "summary_large_image", title: "Robots.txt Checker | RankSEO", description: "Free tool to analyze robots.txt for SEO." },
  alternates: { canonical: "https://www.rankseoengine.com/tools/robots-txt-checker" },
};
