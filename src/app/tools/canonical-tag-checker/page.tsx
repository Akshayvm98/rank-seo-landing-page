...
export const metadata: Metadata = {
  ...
  openGraph: { title: "Canonical Tag Checker | RankSEO", description: "Free tool to check canonical tags for SEO.", url: "https://www.rankseoengine.com/tools/canonical-tag-checker", siteName: "RankSEO", type: "website" },
  ...
  alternates: { canonical: "https://www.rankseoengine.com/tools/canonical-tag-checker" },
};
